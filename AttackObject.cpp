...
bool AttackObject::LoadImg(std::string path, SDL_Renderer* screen)
{
...
SDL_Rect AttackObject::GetRectFrame()
{
	SDL_Rect rect;
	rect.x = rect_.x;
	rect.y = rect_.y;
...
//void AttackObject::CheckToMap(Map& map_data)
//{
//	int x1 = 0;
//	int x2 = 0;
//	int y1 = 0;
...
void AttackObject::Show(SDL_Renderer* des)
{
	...
	if (input_type_.attack_ == 1 || status_ == FIGHT  )
	{
		...
		frame_ = SDL_GetTicks();
		frame_ = ( (frame_ - delay_attack )/ 120) % 8;
...
//void AttackObject::HandleBullet(SDL_Renderer* des)
//{
...
//void AttackObject::RemoveBullet(const int& idx)
//{
...
//void AttackObject::DoPlayer(Map& map_data)
//{
//	if (come_back_time_ == 0)
//	{
//		x_val_ = 0;
...
//void AttackObject::CenterEntityOnMap(Map& map_data)
//{
...
void AttackObject::UpdateImagePlayer(SDL_Renderer* des)
{
	if (on_ground_ == true)
	{
		if (status_ == FIGHT)
		{
			LoadImg("img//Attack2.png", des);
		}
	} 
}