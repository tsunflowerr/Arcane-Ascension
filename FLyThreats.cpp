...
bool FlyThreats::LoadImg(std::string path, SDL_Renderer* screen)
{
...
SDL_Rect FlyThreats::GetRectFrame()
{
	SDL_Rect rect;
	rect.x = rect_.x;
	rect.y = rect_.y;
...
void FlyThreats::Show(SDL_Renderer* des)
{
	if (come_back_time == 0)
	{
		rect_.x = x_pos_;
...
void FlyThreats::DoPlayer(Map& gMap)
{
	if (come_back_time == 0)
	{
...
void FlyThreats::RemoveBullet(const int& idx)
{
...
void FlyThreats::CheckToMap(Map& map_data)
{
	int x1 = 0;
	int x2 = 0;
...
void FlyThreats::ImpMoveType(SDL_Renderer* screen)
{
...
void FlyThreats::MakeBullet(SDL_Renderer* screen, const int& x_limit, const int& y_limit)
{
