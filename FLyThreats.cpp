...
void FlyThreats::DoPlayer(Map& g_map)
{
	if (think_time_ == 0)
	{
		x_val_ = 0;
...
void FlyThreats::CenterEntityOnMap(Map& g_map)
{
...
void FlyThreats::CheckToMap(Map& g_map)
{
	int x1 = 0;
	int x2 = 0;
	int y1 = 0;
...
void FlyThreats::MakeBullet(SDL_Renderer* des, const int& x_limit, const int& y_limit)
{
